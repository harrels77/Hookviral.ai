        ...
        <div style={{ marginBottom: "3rem" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
            {NICHE_MODES.filter(o => o.slug !== n.slug).map(o => (
              <Link key={o.slug} href={`/trends/${o.slug}`} style={{ display: "inline-flex", alignItems: "center", gap: "6px", padding: "6px 14px", borderRadius: "var(--r-pill)", border: "1px solid var(--border-strong)", color: "var(--text-muted)", fontSize: "var(--text-sm)", textDecoration: "none", fontFamily: "var(--fb)" }}>
