      ...
      <div style={{ maxWidth: "860px", margin: "0 auto", padding: "4rem 1.25rem 6rem" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "3.5rem" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginBottom: "1.25rem" }}>
            <span style={{ display: "flex", alignItems: "center", justifyContent: "center", width: "56px", height: "56px", borderRadius: "18px", color: SOURCE_BADGES.tiktok.color, background: `${SOURCE_BADGES.tiktok.color}14` }}>
              <BrandIcon name="tiktok" size={26} />
            </span>
          </div>
