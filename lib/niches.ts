...
export const NICHE_MODES: NicheMode[] = [
  {
    ...
    exampleHooks: [
      ...
      { text: "Stop doing crunches — they're hiding your abs.", formula: "Contrarian", score: 94 },
  ...
  },
  {
    ...
    exampleHooks: [
      ...
      { text: "Your phone is leaking this every single day.", formula: "Loss Aversion", score: 92 },
    ],
  },
  {
    slug: "business",
  ...
  },
  {
    ...
    exampleHooks: [
      ...
      { text: "Your morning routine is killing your best hours.", formula: "Loss Aversion", score: 93 },
  ...
  },
  {
    ...
    exampleHooks: [
      ...
      { text: "You're using AI video tools completely wrong.", formula: "Contrarian", score: 92 },
    ],
  },
];
